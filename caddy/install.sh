#!/bin/bash
REPO="https://raw.githubusercontent.com/N4ND404/4/main/"

curl -1sLf 'https://raw.githubusercontent.com/N4ND404/4/main/gpg.key' | sudo gpg --dearmor -o /usr/share/keyrings/caddy-stable-archive-keyring.gpg --yes  >/dev/null 2>&1
curl -1sLf 'https://raw.githubusercontent.com/N4ND404/4/main/debian.deb.txt' | sudo tee /etc/apt/sources.list.d/caddy-stable.list  >/dev/null 2>&1
